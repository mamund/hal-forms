...
+value+ : This is the value of the "direct" suggest. This is a valid JSON string. This is a REQUIRED element. If this attribute is missing or set to empty, the client SHOULD ignore this +property+ object completely.
+prompt+ : The human-readable prompt for the parameter. This is a valid JSON string. This is an OPTIONAL element". If this element is missing, clients MAY act as if the <code>prompt</code> value is set to the value in the +value+ attribute.

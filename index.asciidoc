...
There is a small set of attributes that are considered _core_ attributes. There are a larger group that are considered _additional_ attributes. Any library supporting the *HAL-FORMS* specification SHOULD support all of the _core_ attributes and MAY support some or all of the _additional_ attributes.

==== Core +property+ Attribbutes
Below is a list of all the _core_ attributes of a +property+ object.
